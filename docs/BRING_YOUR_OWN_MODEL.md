...
| **Search model (embedding)** | `ctx.ai.embed()` — plugin features that compute vector representations (AI Search, related-note suggestions). Used by **AI Assistant** (`silt-ai-qa`; see `docs/plugins/silt-ai-qa.md`) and **Writing Assistant** (`silt-ai-assistant`; see `docs/plugins/silt-ai-assistant.md`) | Local (`http://localhost:11434`) |
