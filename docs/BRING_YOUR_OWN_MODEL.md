...
| **Embedding** | `ctx.ai.embed()` — plugin features that compute vector representations (semantic search, dedup, RAG). Used by **AI Q&A** (`silt-ai-qa`; see `docs/plugins/silt-ai-qa.md`) | Local (`http://localhost:11434`) |
