...
| `insert_under_heading` | write grant | Insert one block after a unique HEADER; bare leaf or `A::B` path; ambiguous → candidates |
| `create_task` | write grant | Standalone TASK (`.silt/tasks.md`) or page override; optional due/owner/tags |
