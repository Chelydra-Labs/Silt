...
| F6 | P2 | (reserved — see audit notes) | Open | — |
| F7 | P1 | Atomic writes use restrictive file permissions (0o600) | Fixed | Prior sprint |
...
| F11 | P2 | (reserved — see audit notes) | Open | — |
| F12 | P2 | (reserved — see audit notes) | Open | — |
...
| F19 | P2 | (reserved — see audit notes) | Open | — |
...
- **M2 (synced-vault adversary):** an attacker who can edit files in a vault
  ...
  reservation), F20 (settings.json fingerprint).
- **M3 (co-tenant / malware with user credentials):** an attacker who can write
  ...
  + 0o600 perms); the hard boundary is filesystem permissions on the home dir.
