      ...
      {#if newBoardComposing}
        <li class="flex items-center gap-1 px-1 py-1">
          <input
            ...
            class="flex-1 px-1.5 py-1 rounded bg-surface-panel border border-accent-primary-start/40 text-text-primary text-[12px] outline-none focus:border-accent-primary-start"
          />
          <button
            type="button"
      ...
      {:else}
        <li>
          <button
            ...
            class="w-full flex items-center justify-center gap-1 px-2 py-1 rounded text-[11px] font-label-sm text-text-muted hover:text-accent-primary-start cursor-pointer border border-dashed border-surface-panel-border bg-transparent transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:text-text-muted"
          >
    ...
    <div class="mt-1 space-y-2">
              ...
              <li>
                ...
                >
                  <input
                    ...
                    data-testid={`owner-${o}`}
                    class="rounded border-surface-panel-border bg-surface-panel"
                  />
      ...
      {#if liveFilters.owners.length || liveFilters.priorities.length || liveFilters.dueDate || liveFilters.tags.length}
        <button
          ...
          class="w-full flex items-center justify-center gap-1 px-2 py-1 rounded text-[11px] font-label-sm text-text-muted hover:text-error cursor-pointer border border-dashed border-surface-panel-border bg-transparent transition-colors"
        >
          <span class="material-symbols-outlined text-[12px]">close</span>
          Clear all filters
        </button>
