...
>
  ...
  >
    ...
    <div class="editor-float-actions__tray">
      ...
      <!-- View Mode Toggle — stable accessible name + aria-pressed; title
           carries the contextual action + live (remappable) hotkey. -->
      <button
        type="button"
...
<style>
  ...
  .editor-float-actions.top-4 {
    top: 1rem;
  }

  .editor-float-actions.top-14 {
    top: 3.5rem;
  }
