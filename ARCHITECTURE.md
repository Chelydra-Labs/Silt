...
Tab / Shift-Tab indent/unindent are hardcoded in SiltBlockKeymaps (config keys
indent_block / unindent_block exist but are not yet wired). Visual nesting uses
data-depth on the outer NodeView root (outerNodeViewAttrs) so
